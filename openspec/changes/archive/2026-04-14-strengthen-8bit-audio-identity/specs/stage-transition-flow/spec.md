...
- **AND** a short synthesized intro cue or opening phrase for that specific stage plays when audio is available
...
- **AND** a synthesized stage-clear or congratulatory cue plays when audio is available
