...
- **THEN** the blow-apart effect stays centered on the player's last position, renders clearly above ordinary gameplay objects, and remains brief enough to hand off cleanly into the existing respawn flow
