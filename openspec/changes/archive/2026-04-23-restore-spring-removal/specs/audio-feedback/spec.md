...
- **WHEN** the player activates a bounce pod, gas vent, collapsing surface, reward block, or equivalent authored interactive object that changes movement or state
