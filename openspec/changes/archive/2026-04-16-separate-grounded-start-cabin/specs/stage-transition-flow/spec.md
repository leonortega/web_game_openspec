...
- **AND** the existing stage flow order and timing semantics remain unchanged apart from an optional bounded fixed-cabin arrival, scripted walk-out, and cabin close beat after the intro surface
