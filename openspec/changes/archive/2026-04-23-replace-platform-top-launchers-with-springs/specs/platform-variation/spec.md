...
#### Scenario: Reading a shipped support-platform launch beat
- **WHEN** the player reaches one of the current shipped green launch beats that sits on support footing in Verdant Impact Crater or Halo Spire Array
- **THEN** that beat reads and behaves as a full-footprint spring platform rather than as a narrower launcher overlay
...
#### Scenario: Reading a shipped spring-converted beat
- **WHEN** the player reaches a current shipped support-platform launch beat in Verdant Impact Crater or Halo Spire Array
- **THEN** the full support footprint reads as one bounded spring-platform traversal beat rather than as a floating or narrower launcher reskin
