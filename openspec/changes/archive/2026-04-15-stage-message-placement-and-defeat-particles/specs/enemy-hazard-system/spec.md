...
- **THEN** each defeat uses a visibly distinct local particle treatment
...
- **THEN** the defeated enemy may emit a short local disappearing-particle burst that matches its defeat cause
