...
- **THEN** that transient message appears in the lower-left safe-area lane instead of top-center
- **AND** it remains visually separate from the primary top HUD band
...
- **THEN** the message remains fully on-screen in the lower-left safe area
- **AND** the top scoreboard HUD band stays readable at the same time
