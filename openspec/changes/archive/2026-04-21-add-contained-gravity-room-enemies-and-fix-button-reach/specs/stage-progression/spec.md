...
- **WHEN** authored validation evaluates an enclosed gravity room whose active gravity setup, button placement, or support geometry makes the intended route to the interior disable button read backwards or become effectively unreachable with the current jump and contact rules
