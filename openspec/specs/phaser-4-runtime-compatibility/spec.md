# phaser-4-runtime-compatibility Specification

## Purpose
Define the engine-compatibility contract that preserves current boot, scene flow, rendering, audio, and playtest behavior under Phaser 4.
