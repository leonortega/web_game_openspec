...
const CUE_PROFILES: Record<AudioCue, CueProfile> = {
  ...
  [AUDIO_CUES.hurt]: { family: 'danger', signature: 'harsh impact rasp', tones: [{ frequency: 146.83, durationMs: 180, type: 'sawtooth', volume: 0.034 }] },
  [AUDIO_CUES.death]: { family: 'death', signature: 'descending shutdown arpeggio', tones: [{ frequency: 196, durationMs: 160, type: 'sawtooth', volume: 0.03 }, { frequency: 146.83, durationMs: 220, type: 'triangle', volume: 0.022, offsetMs: 70 }, { frequency: 110, durationMs: 320, type: 'sine', volume: 0.018, offsetMs: 160 }] },
  [AUDIO_CUES.stomp]: { family: 'combat', signature: 'stomp pop', tones: [{ frequency: 246.94, durationMs: 80, type: 'square', volume: 0.028 }] },
  [AUDIO_CUES.shoot]: { family: 'combat', signature: 'plasma shot pulse', tones: [{ frequency: 587.33, durationMs: 70, type: 'square', volume: 0.028 }] },
  [AUDIO_CUES.shootHit]: { family: 'combat', signature: 'impact crack', tones: [{ frequency: 392, durationMs: 50, type: 'square', volume: 0.022 }, { frequency: 311.13, durationMs: 90, type: 'triangle', volume: 0.018, offsetMs: 24 }] },
  ...
  [AUDIO_CUES.bouncePod]: { family: 'interactive', signature: 'bounce pod boing', tones: [{ frequency: 739.99, durationMs: 80, type: 'triangle', volume: 0.024 }, { frequency: 987.77, durationMs: 110, type: 'square', volume: 0.018, offsetMs: 32 }] },
  [AUDIO_CUES.gasVent]: { family: 'interactive', signature: 'gas vent hiss burst', tones: [{ frequency: 392, durationMs: 90, type: 'sine', volume: 0.02 }, { frequency: 523.25, durationMs: 120, type: 'triangle', volume: 0.016, offsetMs: 28 }] },
