...
export const registerBootTextures = (scene: Phaser.Scene): void => {
  ...
  createPixelTexture(scene, 'walker', 30, 28, (context) => {
    outlinedRect(context, 6, 8, 17, 10, '#d8c2a0');
    fillRect(context, 9, 10, 7, 3, '#11141b');
    fillRect(context, 17, 10, 3, 3, '#f5cf64');
    fillRect(context, 8, 14, 12, 2, '#e97652');
    fillRect(context, 11, 6, 6, 2, '#f7f3d6');
    fillRect(context, 4, 12, 3, 5, '#31451d');
    fillRect(context, 22, 12, 4, 6, '#31451d');
    outlinedRect(context, 8, 18, 4, 7, '#f7f3d6');
    outlinedRect(context, 16, 18, 4, 7, '#f7f3d6');
    fillRect(context, 7, 20, 14, 2, '#11141b');
    fillRect(context, 5, 17, 2, 4, '#11141b');
    fillRect(context, 22, 17, 3, 4, '#11141b');
  });

  createPixelTexture(scene, 'hopper', 30, 28, (context) => {
    outlinedRect(context, 7, 8, 16, 9, '#dfe8bf');
    fillRect(context, 10, 10, 10, 3, '#31451d');
    fillRect(context, 11, 13, 8, 3, '#f5cf64');
    fillRect(context, 12, 5, 6, 3, '#f7f3d6');
    fillRect(context, 6, 14, 3, 2, '#11141b');
    fillRect(context, 21, 14, 3, 2, '#11141b');
    fillRect(context, 8, 17, 14, 2, '#31451d');
    outlinedRect(context, 4, 18, 6, 7, '#f5cf64');
    outlinedRect(context, 20, 18, 6, 7, '#f5cf64');
    fillRect(context, 6, 21, 2, 4, '#11141b');
    fillRect(context, 22, 21, 2, 4, '#11141b');
  });

  createPixelTexture(scene, 'turret', 28, 38, (context) => {
    outlinedRect(context, 9, 4, 10, 12, '#f7f3d6');
    fillRect(context, 11, 7, 6, 4, '#8fdff2');
    fillRect(context, 10, 12, 8, 2, '#11141b');
    outlinedRect(context, 6, 17, 15, 8, '#d8c2a0');
    fillRect(context, 9, 19, 9, 3, '#31451d');
    outlinedRect(context, 18, 9, 7, 5, '#f0c6a1');
    fillRect(context, 21, 10, 4, 2, '#11141b');
    fillRect(context, 4, 21, 3, 3, '#31451d');
    outlinedRect(context, 5, 25, 18, 8, '#c6d2bf');
    fillRect(context, 8, 27, 12, 2, '#11141b');
    fillRect(context, 7, 30, 14, 2, '#31451d');
    fillRect(context, 8, 33, 4, 3, '#f5cf64');
    fillRect(context, 16, 33, 4, 3, '#f5cf64');
  });

  createPixelTexture(scene, 'charger', 34, 30, (context) => {
    outlinedRect(context, 7, 9, 18, 11, '#e97652');
    fillRect(context, 10, 11, 8, 3, '#4d2312');
    fillRect(context, 9, 16, 11, 2, '#f5cf64');
    fillRect(context, 22, 10, 4, 6, '#f7f3d6');
    outlinedRect(context, 25, 11, 5, 5, '#f0c6a1');
    fillRect(context, 5, 12, 2, 4, '#f7f3d6');
    fillRect(context, 2, 13, 3, 2, '#11141b');
    fillRect(context, 29, 12, 3, 2, '#11141b');
    outlinedRect(context, 9, 20, 4, 7, '#f5cf64');
    outlinedRect(context, 18, 20, 4, 7, '#f5cf64');
    fillRect(context, 8, 21, 15, 2, '#11141b');
  });

  createPixelTexture(scene, 'flyer', 34, 24, (context) => {
    outlinedRect(context, 11, 4, 12, 7, '#d6edf2');
    fillRect(context, 14, 6, 6, 3, '#173848');
    fillRect(context, 9, 10, 16, 3, '#9fdae8');
    outlinedRect(context, 5, 10, 6, 4, '#f7f3d6');
    outlinedRect(context, 23, 10, 6, 4, '#f7f3d6');
    fillRect(context, 2, 12, 7, 2, '#8fdff2');
    fillRect(context, 25, 12, 7, 2, '#8fdff2');
    fillRect(context, 11, 13, 12, 3, '#f5cf64');
    fillRect(context, 9, 16, 16, 2, '#fff7d8');
    fillRect(context, 13, 18, 8, 2, '#f5cf64');
    fillRect(context, 12, 2, 3, 2, '#f7f3d6');
    fillRect(context, 19, 2, 3, 2, '#f7f3d6');
  });
  ...
  createPixelTexture(scene, 'checkpoint', 24, 80, (context) => {
    outlinedRect(context, 7, 4, 10, 12, '#f7f3d6');
    fillRect(context, 9, 7, 6, 4, '#8fdff2');
    outlinedRect(context, 9, 16, 6, 50, '#c6d2bf');
    fillRect(context, 7, 24, 10, 4, '#11141b');
    fillRect(context, 7, 40, 10, 4, '#11141b');
    fillRect(context, 8, 18, 8, 2, '#31451d');
    fillRect(context, 8, 56, 8, 2, '#31451d');
    outlinedRect(context, 4, 68, 16, 8, '#f5cf64');
    fillRect(context, 8, 70, 8, 4, '#fff7d8');
  });
