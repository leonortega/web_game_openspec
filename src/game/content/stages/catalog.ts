...
const forestRuinsExtension: StageExtension = {
  ...
  gravityCapsules: [
    gravityCapsule(
      ...
      { x: 8894, y: 516, width: 42, height: 46 },
      { x: 9258, y: 516, width: 42, height: 46 },
      { id: 'forest-anti-grav-canopy-room-button', x: 9034, y: 216, width: 34, height: 32 },
      { x: 8880, y: 506, width: 76, height: 24 },
      { x: 9010, y: 226, width: 98, height: 24 },
      { x: 9226, y: 506, width: 88, height: 24 },
      {
...
const amberCavernExtension: StageExtension = {
  ...
  gravityCapsules: [
    gravityCapsule(
      'amber-inversion-smelter-room',
      'amber-inversion-smelter-column',
      { x: 9970, y: 108, width: 790, height: 494 },
      { x: 10034, y: 556, width: 42, height: 46 },
      { x: 10588, y: 556, width: 46, height: 46 },
      { id: 'amber-inversion-smelter-room-button', x: 10448, y: 228, width: 34, height: 32 },
      { x: 10010, y: 546, width: 80, height: 24 },
      { x: 10412, y: 236, width: 120, height: 24 },
      { x: 10540, y: 546, width: 92, height: 24 },
      {
        platformIds: [
          'platform-9990-570',
          'platform-10290-500',
...
const skySanctumExtension: StageExtension = {
  ...
  terrainSurfaces: [],
  launchers: [launcher('sky-gas-vent-route', 'gasVent', 9312, 240, 96, 14, { x: 0.18, y: -1 })],
  lowGravityZones: [],
  gravityFields: [
  ...
  gravityCapsules: [
    gravityCapsule(
      ...
      { x: 8928, y: 108, width: 304, height: 396 },
      { x: 9000, y: 458, width: 42, height: 46 },
      { x: 9140, y: 458, width: 42, height: 46 },
      { id: 'sky-anti-grav-capsule-button', x: 9058, y: 268, width: 34, height: 32 },
      { x: 9010, y: 456, width: 64, height: 24 },
      { x: 9044, y: 276, width: 142, height: 24 },
      { x: 9120, y: 456, width: 70, height: 24 },
      {
    ...
    gravityCapsule(
      ...
      { x: 9518, y: 526, width: 40, height: 46 },
      { x: 9818, y: 526, width: 40, height: 46 },
      { id: 'sky-gravity-inversion-room-button', x: 9600, y: 308, width: 34, height: 32 },
      { x: 9502, y: 516, width: 72, height: 24 },
      { x: 9554, y: 316, width: 126, height: 24 },
      { x: 9802, y: 516, width: 92, height: 24 },
      {
        platformIds: [
          'platform-9490-540',
          'platform-9540-340',
